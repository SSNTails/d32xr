...
STATE2(SPR_CBFS,0,1,A_Look,1024,1,S_FACESTABBER_STND1),   // S_FACESTABBER_STND1
...
STATE(SPR_CBFS,0,TICRATE,A_Pain,S_FACESTABBER_PAIN2), // S_FACESTABBER_PAIN
STATE(SPR_CBFS,0,1,A_FaceStabUnPain,S_FACESTABBER_STND1), // S_FACESTABBER_PAIN2
...
STATE2(SPR_SPSH,6,1,A_GuardChase,1,0,S_EGGGUARD_RUN2),  // S_EGGGUARD_RUN1
...
STATE(SPR_CBUS,0,-1,NULL,S_NULL), // S_CEZBUSH1
STATE(SPR_CBUS,1,-1,NULL,S_NULL), // S_CEZBUSH2
STATE(SPR_FWR4,0,-1,NULL,S_NULL), // S_CEZFLOWER
STATE(SPR_PINE,0,-1,NULL,S_NULL), // S_PINETREE
STATE(SPR_CNDL,FF_FULLBRIGHT,-1,NULL,S_NULL), // S_CANDLE
STATE(SPR_CNDL,FF_FULLBRIGHT|1,-1,NULL,S_NULL), // S_CANDLEPRICKET

STATE(SPR_FLMH,0,-1,NULL,S_NULL), // S_FLAMEHOLDER

STATE(SPR_CTRC,FF_FULLBRIGHT,3,NULL,S_FIRETORCH2), // S_FIRETORCH1
STATE(SPR_CTRC,FF_FULLBRIGHT|1,3,NULL,S_FIRETORCH3), // S_FIRETORCH2
STATE(SPR_CTRC,FF_FULLBRIGHT|2,3,NULL,S_FIRETORCH4), // S_FIRETORCH3
STATE(SPR_CTRC,FF_FULLBRIGHT|3,3,NULL,S_FIRETORCH1), // S_FIRETORCH4

STATE(SPR_BANR,0,-1,NULL,S_NULL), // S_BANNER_RED
STATE(SPR_BANR,1,-1,NULL,S_NULL), // S_BANNER_BLUE
STATE(SPR_FLAM,FF_FULLBRIGHT,2,NULL,S_TORCH2), // S_TORCH1
STATE(SPR_FLAM,FF_FULLBRIGHT|1,2,NULL,S_TORCH3), // S_TORCH2
STATE(SPR_FLAM,FF_FULLBRIGHT|2,2,NULL,S_TORCH4), // S_TORCH3
STATE(SPR_FLAM,FF_FULLBRIGHT|3,2,NULL,S_TORCH1), // S_TORCH4
STATE(SPR_ESTA,0,-1,NULL,S_NULL), // S_EGGSTATUE1
STATE(SPR_CSTA,0,-1,NULL,S_NULL), // S_CRAWLASTATUE
STATE(SPR_CBBS,0,-1,NULL,S_NULL), // S_FACESTABBERSTATUE

// CEZ maces and chains
STATE(SPR_SMCH,0,-1,NULL,S_NULL), // S_SMALLMACECHAIN
STATE(SPR_BMCH,0,-1,NULL,S_NULL), // S_BIGMACECHAIN
STATE(SPR_SMCE,0,-1,NULL,S_NULL), // S_SMALLMACE
...
STATE(SPR_HOOK,FF_FULLBRIGHT,6,NULL,S_HOOK2), // S_HOOK1
STATE(SPR_HOOK,1|FF_FULLBRIGHT,6,NULL,S_HOOK1), // S_HOOK2
STATE(SPR_HOOK,FF_FULLBRIGHT,3,NULL,S_HOOK4), // S_HOOK3
STATE(SPR_HOOK,1|FF_FULLBRIGHT,3,NULL,S_HOOK3), // S_HOOK4

STATE(SPR_STLG,0,-1,NULL,S_NULL), // S_STLG0
STATE(SPR_STLG,1,-1,NULL,S_NULL), // S_STLG1
STATE(SPR_STLG,2,-1,NULL,S_NULL), // S_STLG2
STATE(SPR_STLG,3,-1,NULL,S_NULL), // S_STLG3
STATE(SPR_STLG,4,-1,NULL,S_NULL), // S_STLG4
STATE(SPR_STLG,5,-1,NULL,S_NULL), // S_STLG5
STATE(SPR_STLG,6,-1,NULL,S_NULL), // S_STLG6
STATE(SPR_STLG,7,-1,NULL,S_NULL), // S_STLG7

STATE(SPR_JPLA,0,-1,NULL,S_NULL), // S_BIGFERN
STATE(SPR_JPLA,1,-1,NULL,S_NULL), // S_JUNGLEPALM

STATE(SPR_TFLO,0,1,NULL,S_TORCHFLOWER2), // S_TORCHFLOWER1
STATE(SPR_TFLO,FF_FLIPPED,1,NULL,S_TORCHFLOWER1), // S_TORCHFLOWER2
...
STATE(SPR_EFIR,FF_FULLBRIGHT,4,NULL,S_JETFLAME2), // S_JETFLAME1
STATE(SPR_EFIR,1|FF_FULLBRIGHT,4,NULL,S_JETFLAME1), // S_JETFLAME2
...
STATE2(SPR_EGGN,0,2,A_Boss2PogoTarget,9,8,S_EGGMOBILE2_POGO3), // S_EGGMOBILE2_POGO2
STATE(SPR_EGGN,1,2,NULL,S_EGGMOBILE2_POGO4), // S_EGGMOBILE2_POGO3
STATE(SPR_EGGN,2,-1,NULL,S_NULL), // S_EGGMOBILE2_POGO4
STATE(SPR_EGGN,1,4,NULL,S_EGGMOBILE2_POGO6), // S_EGGMOBILE2_POGO5
STATE2(SPR_EGGN,0,2,A_Boss2PogoTarget,7,8,S_EGGMOBILE2_POGO7), // S_EGGMOBILE2_POGO6
STATE(SPR_EGGN,1,2,NULL,S_EGGMOBILE2_POGO4), // S_EGGMOBILE2_POGO7
STATE2(SPR_EGGN,3,24,A_Boss2TakeDamage,24+TICRATE,0,S_EGGMOBILE2_STND), // S_EGGMOBILE2_PAIN
STATE2(SPR_EGGN,4,24,A_Boss2TakeDamage,24+TICRATE,0,S_EGGMOBILE2_POGO4), // S_EGGMOBILE2_PAIN2
STATE(SPR_EGGN,5,2,A_Fall,S_EGGMOBILE2_DIE2), // S_EGGMOBILE2_DIE1
STATE(SPR_EGGN,5,2,A_BossScream,S_EGGMOBILE2_DIE3), // S_EGGMOBILE2_DIE2
STATE2(SPR_EGGN,5,0,A_Repeat,17,S_EGGMOBILE2_DIE2,S_EGGMOBILE2_DIE4), // S_EGGMOBILE2_DIE3
STATE(SPR_EGGN,5,-1,A_BossDeath,S_NULL), // S_EGGMOBILE2_DIE4
STATE2(SPR_EGGN,6,2,A_BossScream,90,MT_EXPLODE,S_EGGMOBILE2_FLEE2), // S_EGGMOBILE2_FLEE1
STATE(SPR_EGGN,6,2,A_BossScream,S_EGGMOBILE2_FLEE1), // S_EGGMOBILE2_FLEE2

STATE(SPR_TANK,0,35,NULL,S_NULL), // S_BOSSTANK1
STATE(SPR_TANK,1,35,NULL,S_NULL), // S_BOSSSPIGOT
...
MF2_SHOOTABLE, // flags2
 ...
 {           // MT_RING_BOX
	...
	{           // MT_EGGMOBILE2
		...
		(statenum_t)S_EGGMOBILE2_POGO1, // missilestate
